...
Esse documento dá uma visão gerãl de como o código do asgard está organziado.

O pacote principal é o `:py:package:asgard`. Dentro desse pacote temos algumas macro-subdivisões.
