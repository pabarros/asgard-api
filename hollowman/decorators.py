...
no_associated_account_response_error = json.dumps(
    {"msg": "No associated account"}
)
account_does_not_exist_response_error = json.dumps(
            ...
            try:
                ...
                if not user.accounts:
                    return make_response(
                        no_associated_account_response_error, 401
                    )
                ...
                if request_account_id and not request_account_on_db:
                    return make_response(
                        account_does_not_exist_response_error, 401
                    )
