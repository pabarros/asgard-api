...
class TestBasicConstraintFilter(unittest.TestCase):
    ...
    def test_request_app_has_all_constraints_original_app_constraints_is_empty(
        self
    ):
    ...
    def test_request_app_has_single_constraint_original_app_constraints_is_empty(
        self
    ):
    ...
    def test_it_adds_only_workload_constraint_if_request_app_does_not_have_any_workload_constraint(
        self
    ):
        self.request_app.constraints = [
