...
class TestNamespaceFilter(unittest.TestCase):
    ...
    def test_add_namespace_create_new_app(self):
        ...
        """
        modified_app = self.filter.write(self.user, self.request_app, AsgardMarathonApp())
        self.assertEqual("/dev/foo", modified_app.id)
    ...
    def test_response_apps_remove_namespace_from_app_id_containig_namespace_in_its_name(self, single_full_app_with_tasks_fixture):
        ...
        """
        response_app = original_app = AsgardMarathonApp.from_json(single_full_app_with_tasks_fixture)
    ...
    def test_response_apps_remove_namespace_from_all_tasks(self, single_full_app_with_tasks_fixture):
        request_app = original_app = AsgardMarathonApp.from_json(single_full_app_with_tasks_fixture)
